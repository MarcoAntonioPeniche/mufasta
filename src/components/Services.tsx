...
const Services = () => {
  ...
  const services = [
    ...
    {
      icon: iconBarba,
      alt: "Ícone de barba e cabelo",
      title: "Barba + Cabelo",
      price: "R$ 60,00",
      description: "Pacote completo com barba e corte",
      featured: true,
    },
    {
      icon: iconPezinho,
    ...
    {
      icon: iconCorte,
      alt: "Ícone de platinado",
      title: "Platinado",
      price: "R$ 100,00",
      description: "Descoloração completa profissional",
      featured: false,
    },
    {
      icon: iconCorte,
      alt: "Ícone de raspagem",
      title: "Raspagem Total",
      price: "R$ 25,00",
      description: "Raspagem completa na máquina",
      featured: false,
    },
  ];
